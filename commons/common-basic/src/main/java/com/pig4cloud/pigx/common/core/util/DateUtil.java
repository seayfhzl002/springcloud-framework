...
// e.printStackTrace();
    ...
    public static int Unx(String time) {
     ...
     * @return
     */
    public static Long timeZoneTimestamp(DateTime dateTime) {
        String s = dateStringFormat(dateTime);
        Long unx = timestamp(s);
        return unx;
    }

    @SneakyThrows
    public static List<Date> parseTimeRange(String startTime, String endTime, String format) {
        List<Date> ret = new ArrayList<>();
        SimpleDateFormat dateFormat = new SimpleDateFormat(format);
        Date startTimeDate = dateFormat.parse(startTime);
        Date endTimeDate = dateFormat.parse(endTime);
        Calendar cal = Calendar.getInstance();
        cal.set(startTimeDate.getYear(), startTimeDate.getMonth(), startTimeDate.getDate());

        Calendar calEnd = Calendar.getInstance();
        calEnd.set(endTimeDate.getYear(), endTimeDate.getMonth(), endTimeDate.getDate());
//        Date currDate = startTimeDate;
