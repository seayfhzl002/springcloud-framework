package com.ehome.fintech.user.auth.config;

import java.util.Arrays;
import java.util.List;

import com.ehome.fintech.user.auth.config.resource.AppFilterInvocationSecurityMetadataSource;
import com.ehome.fintech.user.auth.config.resource.RoleBasedVoter;
